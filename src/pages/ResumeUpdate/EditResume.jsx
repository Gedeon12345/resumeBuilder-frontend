...
const EditResume = () => {
        ...
        switch (currentPage) {
                ...
                resumeData.workExperience.forEach(
                    ({ company, role, startDate, endDate }, index) => {
                        ...
                        if (!startDate || !endDate)
                            errors.push(
                                `Start date and end date are required in experience ${index + 1}`
                            );
                    }
                )
                break;
            ...
            case "skills":
                resumeData.skills.forEach(({ name, progress }, index) => {
                        ...
                        if (progress < 1 || progress > 100)
                            errors.push(
                                `Skills progress must be between 1 and 100 in skill ${index + 1}`
                            );
                    });
                break;
            ...
            case "certifications":
                resumeData.certifications.forEach(({ title, issuer }, index) => {
                    if (!title.trim())
                        errors.push(`Certification title is required in certificationn ${index + 1}`
                    );
                    if (!issuer.trim())
    ...
    // Update array item (Like workExperience[0], skils[1], etc...)
    ...
    const reactToPrintFn = useReactToPrint(
        { 
            ...
            documentTitle: resumeData.title || "Mon CV", 
            onAfterPrint: () => ("Finish") 
        }
    );
            ...
            <div className="container mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div className="bg-white rounded-lg border border-purple-100 overflow-hidden">
                        ...
                        <div className="mx-5">
                            {errorMsg && (
                                <div className="flex items-center gap-2 text-[11px] font-medium text-amber-600 bg-amber-100 px-2 py-0.5 my-1 rounded-sm">
...
// https://github/in/resumeBuilder
// https://vercel-app/resumeBuilder.app
