...
const TemplateOne = ({ resumeData, colorPalette, containerWidth }) => {
    ...
    const [baseWidth, setBaseWidrh] = useState(800); // Default value
    const [scale, setScale] = useState(1);

    useEffect(() => {
        // Calculate the scale based on the container width
        const actualBaseWidth = resumeRef.current.offsetWidth;
        setBaseWidrh(actualBaseWidth) // Get the actual base width
            ...
            <div className="grid grid-cols-12 gap-8">
                ...
                >
                        ...
                        >
                            {resumeData.profileInfo.profilePreviewUrl ? (
                                <img 
                                    ...
                                    className='w-[90px] h-[90px] rounded-full object-cover object-center'
                                />
                            ) : (
                                <div
                    ...
                    <div className="my-6 mx-6">
                        ...
                        <div className="mt-5">
                            ...
                            <LanguageSection
                                langueges={resumeData.languages}
                ...
                <div className="col-span-8 pt-10 mr-10 pb-5">
                    ...
                    {resumeData.interests.length > 0 && resumeData.interests[0] !== "" && (
                        <div className="mt-4">
                            <Title text="Interest" color={themeColors[1]} />
